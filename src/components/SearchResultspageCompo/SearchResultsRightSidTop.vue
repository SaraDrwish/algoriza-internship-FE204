<template>
  <div>
    <div class="flex items-center justify-between mb-[24px]">
      ...
      >
        <button
          class="flex items-center justify-between border-solid border-1 border-bordersr w-[100%] rounded-[6px] py-[8px] px-[12px] bg-transparent hover:bg-transparent"
        >
          <div
            @click="toggleModalSerch"
            class="flex justify-between items-center w-full gap-[2px]"
          >
