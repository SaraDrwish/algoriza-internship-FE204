    ...
    <div class="flex gap-[30px] border-t-2 border-borderserbox pt-[40px]">
      <div class="w-[68%]">
        <div class="flex flex-col gap-[12px] flex-2">
          <p class="text-[32px] font-[600] text-checkoutText1">
          ...
          <div class="flex gap-[6px] mb-[31px]">
            <img
              class="w-[20px] h-[20px]"
              src="../../assets/icons/location2.svg"
              alt="locationPD"
            />
            <span class="text-[14px] text-Gray2"
              >Lorem ipsum road, Tantruim-2322, Melbourne, Australia</span
            >
          </div>
          <!-- /////// -->

          <div class="rounded-[6px] bg-white">
            <p
              class="pt-[24px] pl-[30px] mb-[20px] text-[18px] text-checkoutText1 font-[500]"
            >
              Overview
            </p>

            <div
              class="pl-[30px] mb-[44px] mr-[40px] text-[16px] text-light-black"
            >
              <p>
            ...
            <hr
              class="fill-borderserbox text-borderserbox border-borderserbox"
            />

            <div class="mt-[26px] pl-[30px] pb-[40px]">
              <p class="mb-[24px] text-[18px] font-[500] text-checkoutText1">
                Top facilities
              </p>
              <ul class="flex text-[15px] gap-[100px] text-light-black">
                <div class="flex flex-col gap-[13px]">
                  <li class="flex gap-[12px]">
                    <img src="../../assets/icons/home-wifi 1.svg" alt="wifi" />
                    <span>Free wifi</span>
                  </li>
                  <li class="flex gap-[12px]">
                    <img src="../../assets/icons/wind 1.svg" alt="wind" />
                    <span>Air Conditioning</span>
                  </li>
                  <li class="flex gap-[12px]">
                    <img src="../../assets/icons/car 1.svg" alt="car" />
                ...
                <div class="flex flex-col gap-[13px]">
                  <li class="flex gap-[12px]">
                    <img src="../../assets/icons/bag-tick-2 1.svg" alt="bag" />
                    <span>Business Services</span>
                  </li>
                  <li class="flex gap-[12px]">
                    <img
                      src="../../assets/icons/lifebuoy 1.svg"
                      alt="lifebuoy"
                    />
                    <span>Swimming pool</span>
                  </li>
                  <li class="flex gap-[12px]">
                    <img src="../../assets/icons/like-1 1.svg" alt="like" />
      ...
      <div class="flex flex-col flex-1 w-[29%] gap-[35px]">
        <div class="w-[100%] h-[240px]">
          <img
            class="w-full h-[100%] rounded-[6px]"
            src="../../assets/imgs/locationmap1.png"
            alt="locationmap1"
          />
        </div>
        <div class="gap-[22px]">
          ...
          <ul class="flex flex-col justify-between text-[14px] gap-[12px]">
            <li class="flex justify-between">
              <div class="flex gap-[8px]">
                <img
                  src="../../assets/icons/bxs-plane-alt 2.svg"
                  alt="bxs-plane-alt 2.svg"
                />
            ...
            <li class="flex justify-between">
              <div class="flex gap-[8px]">
                <img src="../../assets/icons/bxs-map 1.svg" alt="locationPD2" />
