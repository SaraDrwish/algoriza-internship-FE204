<template>
  <div class="container mb-[60px]">
    <div class="flex flex-col m-auto gap-[24px]">
      <div class="">
        <span class="text-dark-black text-[28px] font-[600]"
          >Get inspiration for your next trip</span
        >
      </div>
      <div class="flex gap-[20px] text-white">
        <div class="relative flex flex-col w-[calc(100%/3)]">
          <div class=" ">
            <div
              class="h-[280px] w-full bg-black opacity-[25%] rounded-[8px] absolute top-0"
            ></div>
            <img
              class="rounded-[8px] w-full h-[280px]"
              src="../../assets/imgs/getinsp1.jpeg"
              alt="img1"
            />
          </div>
          <div
            class="flex flex-col absolute bottom-[20px] gap-[10px] mx-[20px]"
          >
            <h5 class="text-[20px]">
        ...
        <div class="flex relative flex-col w-[calc(100%/3)]">
          <div class=" ">
            ...
            <img
              class="rounded-[8px] w-full h-[280px]"
              src="../../assets/imgs/gitinsp3.jpeg"
              alt="img1"
            />
          </div>
          <div
            class="flex flex-col absolute bottom-[20px] gap-[10px] w-[90%] mx-[20px]"
          >
            <h5 class="text-[20px]">
